...
public class Film  implements java.io.Serializable {
    ...
    public String toString() {
        return "Film{" + "filmId=" + filmId + ", languageByLanguageId=" + languageByLanguageId + ", languageByOriginalLanguageId=" + languageByOriginalLanguageId + ", title=" + title + ", description=" + description + ", releaseYear=" + releaseYear + ", rentalDuration=" + rentalDuration + ", rentalRate=" + rentalRate + ", length=" + length + ", replacementCost=" + replacementCost + ", rating=" + rating + ", specialFeatures=" + specialFeatures + ", lastUpdate=" + lastUpdate + ", filmCategories=" + filmCategories + '}';
    }
